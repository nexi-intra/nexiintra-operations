...
$inputFile = join-path  $koksmatDir "manifests" "jobs" $jobName "koksmat.json"
          ...
          - name: job-$jobName
            ...
            args:
              - |
                ...
                magic-mix extract hubsite-spokes-pages

                echo "Extraction completed, starting to transform data ...";

                echo TODO magic-mix upload audit

                echo "Transformation completed, starting to load data ...";

                echo TODO magic-mix move mix files sharepoint.pageviews events insert_audit_records
